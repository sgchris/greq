...
fn test_enrich_with_empty_self_filled_other() {
    ...
    assert_eq!(self_header.extends, Some("base.greq".to_string()));
...
fn test_enrich_with_filled_self_empty_other() {
    let mut self_header = GreqHeader {
        ...
        is_http: false,
        extends: Some("self_base.greq".to_string()),
    ...
    assert_eq!(self_header.extends, Some("self_base.greq".to_string()));
...
fn test_enrich_with_both_filled_self_takes_precedence() {
    ...
    let other_header = GreqHeader {
        ...
        is_http: true,
        extends: Some("other_base.greq".to_string()),
...
fn test_enrich_with_partial_merge() {
    ...
    assert_eq!(self_header.extends, Some("self_base.greq".to_string())); // unchanged (has value)
...
fn test_enrich_with_both_none_remains_none() {
    ...
    assert_eq!(self_header.is_http, false);
    assert_eq!(self_header.extends, None);
...
fn test_enrich_with_special_characters() {
    ...
    let other_header = GreqHeader {
        ...
        extends: Some("base-request.greq".to_string()),
    ...
    assert_eq!(self_header.extends, Some("base-request.greq".to_string()));
